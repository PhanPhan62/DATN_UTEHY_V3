...
router.get("/GiaoHangDonHang/:id", ordersController.GiaoHangDonHang);
router.get("/getAll", ordersController.getAll1);
...
router.post("/zalopay", ordersController.zaloPay, ordersController.callback);

router.post("/momo", (req, res, next) => {
